...
export default function CampaignPage() {
  ...
  const { progress, markAnswered, unlock, reset, getFirstUnansweredIndex, allLettersCollected } =
      ...
      <ScreenLayout accentColor={campaign.theme.accent} showVaultHeader={false}>
        <div className="absolute bottom-0 left-0 right-0 px-6 pb-6">
          <div className="max-w-md mx-auto w-full text-center space-y-8">
            <img src="/images/logo.png" alt="Redthread Market Access" className="mx-auto w-32" />
            <p className="text-white text-xl leading-snug">
              {campaign.copy.landingTitle} <span className="font-bold italic">{campaign.copy.landingBody}</span>
            </p>
            <NeonButton
      ...
      <ScreenLayout accentColor={campaign.theme.accent} showVaultHeader={false}>
        <div className="absolute bottom-0 left-0 right-0 px-6 pb-6">
          <div className="max-w-md w-full mx-auto flex flex-col items-center gap-3">
            ...
            <p className="text-base text-xl leading-snug text-white text-center">{question.prompt}</p>
            ...
            <ProgressCircles count={codeLength} letters={progress.lockedLetters} accentColor={campaign.theme.accent} />
  ...
  if (screen.type === "final") {
    ...
    return (
      <ScreenLayout accentColor={campaign.theme.accent} showVaultHeader={false}>
        ...
        {/* Content at bottom */}
        <div
          className={`absolute bottom-0 left-0 right-0 px-6 pb-6 z-20 ${showVaultScene ? "opacity-0 transition-opacity duration-500" : ""}`}
        >
          <div className="max-w-md mx-auto space-y-3">
            ...
            <p className="text-sm leading-snug text-white text-center">
              Unscramble the letters to reveal the vault keyword. Type it below and submit to see if you&apos;ve{" "}
            ...
            <form onSubmit={handleFinalSubmit} className="space-y-3">
              ...
              <NeonButton type="submit" accentColor={campaign.theme.accent} disabled={!canSubmit} fullWidth>
                &gt; SUBMIT CODE
              </NeonButton>
            </form>
          </div>
      ...
      <ScreenLayout accentColor={campaign.theme.accent} showVaultHeader={false}>
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 pb-6 z-20 pointer-events-none">
          <div className="max-w-md mx-auto text-center space-y-3 pointer-events-auto">
            ...
            <NeonButton onClick={() => setScreen({ type: "enter" })} accentColor={campaign.theme.accent} fullWidth>
